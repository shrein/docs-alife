...
% 2. What is the artificial life approach to evolutionary robotics
% 3. What has been done in biped robotics (detail static and dynamic
% control)
% 4. Why goal-oriented control is lacking but desirable
% 5. Why neural fields for goal-oriented control and (the little)
% previous work 
% 6. Why biped walking as inverted-pendulum and previous work. Brief
% comparison with reference-tracking control.
% 7. Previous work on inverted pendulum control with computational
% intelligence methods emphasizing RNNs 
