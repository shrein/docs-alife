% \chapter{On information processing in neural field controllers} 
\label{ch:chp3}
...
\cite{Amari77Dynamics}, but with an specific structure for the interconnection
between input layer and representation layer populations, and also, a
minor role of recurrence.
...
action than the SMNF controller, but it provides a monotonic
